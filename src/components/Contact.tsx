                    ...
                    >
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-gray-600 dark:text-gray-300">+923322497339</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-gray-600 dark:text-gray-300">tassadaq.contrive@gmail.com</p>
                                </div>
                            </div>
                        ...
                        <div className="mt-10">
                            ...
                            <div className="flex space-x-4">
                                <a href="https://github.com/tassadaqtechstream" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-100 dark:bg-gray-800 rounded-full text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                                ...
                                <a href="www.linkedin.com/in/tassadaq-hussain-8013bb352" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-100 dark:bg-gray-800 rounded-full text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
